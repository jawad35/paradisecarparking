        ...
        <div className='wrapper'>
          ...
          <div className='leftside-menu leftside-menu-detached'>
            ...
            <ul className='side-nav'>
              ...
              <li className='side-nav-item' onClick={dashboardToggle}>
                <div
              ...
              <li className='side-nav-item' onClick={AdminProfiles}>
                <span className='side-nav-link'>
                  <i className='uil-comments-alt' />
                  ...
                  <ul className='side-nav-second-level'>
                    ...
                    <li>
                      <a href='apps-projects-gantt.html'>
                        Gantt{' '}
                        <span className='badge rounded-pill badge-dark-lighten text-dark font-10 float-end'>
                          New
                        </span>
                      </a>
                    </li>
